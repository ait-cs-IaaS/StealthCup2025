...
$FileshareName = "Share"
$FilesharePath = "C:\Fileshares\Share"
$FileshareReadAccessUsernames = "$Domain\Authenticated Users" # format: "CORP.LOCAL\alice","CORP.LOCAL\Domain Admins"
...
if ($Status -eq "") {
    ...
    [Utils]::HostFileshare($FileshareName, $FilesharePath, $FileshareReadAccessUsernames)
