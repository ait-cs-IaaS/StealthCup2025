...
def main():
    ...
    machines_skipped = ['dmz_domain_controller', 'dmz_historian', 'dmz_jump', 'enterprise_client', 'enterprise_domain_controller', 'enterprise_file_server', 'monitoring_dragos', 'supervision_engineer_workstation', 'supervision_scada']
